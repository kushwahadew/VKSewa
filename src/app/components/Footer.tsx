      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          <div className="lg:col-span-1">
            <div className="flex items-center gap-4 mb-8">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-teal-400 to-emerald-600 flex items-center justify-center text-foreground font-black text-xl shadow-lg">
                  VK
                </div>
              ...
              VK Seva Foundation is dedicated to creating sustainable social impact through innovation, transparency, and community empowerment.
            </p>
        ...
        <div className="pt-12 border-t border-card flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="text-muted text-sm font-medium">
            &copy; {new Date().getFullYear()} VK Seva Foundation. All rights reserved.
          </div>
